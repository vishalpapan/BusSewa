...
class Bus(models.Model):
    ...
    capacity = models.IntegerField(default=42)  # Updated to 42 seats
    route_name = models.CharField(max_length=100, blank=True)
    journey = models.ForeignKey(Journey, on_delete=models.CASCADE, related_name='buses')
...
class SeatCancellation(models.Model):
    ...
    journey_type = models.CharField(max_length=10, choices=[('ONWARD', 'Onward'), ('RETURN', 'Return'), ('BOTH', 'Both')])
